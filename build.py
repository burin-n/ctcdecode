...
download_extract('https://phoenixnap.dl.sourceforge.net/project/boost/boost/1.67.0/boost_1_67_0.tar.gz',
...
compile_args = ['-O3', '-DKENLM_MAX_ORDER=20', '-std=c++14', '-fPIC']
ext_libs = []
...
compile_args.extend(['-DINCLUDE_KENLM', '-DKENLM_MAX_ORDER=20'])
